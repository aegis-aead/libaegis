...
{
    // Direct return to help compiler optimize
...
// Using explicit pointers to help the compiler optimize memory access
static inline aes_block_t
...
// Highly optimized aegis128x4_update for AMD Zen 4
...
{
    // Save state[7] before it's modified
